<?php
            ...
            if(!email_exists($email)){
                ...
                if($password === $confirm_password){
                    if(register_user($first_name, $last_name, $email, $password)) {
                        ...
                        echo "<script>alert('Registration is SucessFul.')</script>";
                    }
                }
                else{
    ...
    function register_user($first_name, $last_name, $email, $password) {
        ...
        $msg = "Welcome To Our Website  " .$first_name. " ,<br/><br/>
            ...
            <a href='http://localhost/nehali/Assignment-3/Front/EmailVerification.php?email={$email}&name={$first_name}'>Email verification link</a><br/><br/>
            Regards,<br/>
            Nehali M Padsala<br/>";
    ...
    function insert_user_profile() {
        if(isset($_POST['user_profile_submit'])){
            echo "<script>alert('file form
            at not supported for Display Picture')</script>";
...
//            if(is_uploaded_file($_FILES['note_pdf']['tmp_name']))
            if(!empty($note_pdf)){
    ...
    function contact_us() {
        ...
        if(isset($_POST['contact-submit'])) {
            ...
            if(send_email($email, $subject_new, $msg, $headers)) {
                ...
                echo "<script>alert('Unable to contacting us Please Try again.');</script>";
            }
