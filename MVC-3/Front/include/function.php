<?php
    ...
    function register_user($first_name, $last_name, $email, $password) {
        ...
        $msg = "Welcome To Our Website  " .$first_name. " ,<br/><br/>
            ...
            <a href='http://localhost/Nehu/New Folder/PHP Assignment-3/Front/EmailVerification.php?email={$email}&name={$first_name}'>Email verification link</a><br/><br/>
            Regards,<br/>
            Parth R Solanki<br/>";
        $headers = "From: notemarketplace19@gmail.com";
    ...
    function forgot_password() {
     ...
     function contact_us() {
        ...
        if(isset($_POST['contact-submit'])) {
            ...
            $headers = "From: notemarketplace19@gmail.com";
            $email = "notemarketplace19@gmail.com";
        ...
        if(isset($_POST['add_admin_submit'])){
            ...
            if(!email_exists($email)) {
                ...
                $msg = "Hello $first_name $last_name,<br/><br/>
                        ...
                        Regards,<br/>
                        Notes Marketplace";
                $headers = "From: notesmarketplace19@gmail.com";
