    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light" id="mynav">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarmenu">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="search.html">Search Notes</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 col-md-7" id="nd-note-description">
                            ...
                            <div id="nd-download-btn">
                                <a class="btn btn-general btn-purple" href="#" title="Download" role="button" data-toggle="modal" data-target="#thanksModal">Download / $15</a>
                            </div>
                        </div>
                    </div>
                </div>
