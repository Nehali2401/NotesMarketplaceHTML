            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="notes-card">
                        ...
                        <div class="notes-card-content">
                            <h5><a href="Note-Details.html">Computer Operating System - Final Exam Book With Paper Solution</a></h5>
                ...
                <div class="col-md-4">
                    <div class="notes-card">
                        ...
                        <div class="notes-card-content">
                            <h5><a href="Note-Details.html">Computer Science</a></h5>
                            <ul class="notes-card-content-details">
                                <li><i class="fa fa-university"></i><span>University of California, US</span></li>
                                <li><i class="fa fa-book"></i><span>204 Pages</span></li>
                                <li><i class="fa fa-calendar"></i><span>Thu, Dec 24 2020</span></li>
                ...
                <div class="col-md-4">
                    <div class="notes-card">
                        ...
                        <div class="notes-card-content">
                            <h5><a href="Note-Details.html">Basic Computer Engineering Tech India Publication Series</a></h5>
                            <ul class="notes-card-content-details">
                                <li><i class="fa fa-university"></i><span>University of California, US</span></li>
                                <li><i class="fa fa-book"></i><span>204 Pages</span></li>
                                <li><i class="fa fa-calendar"></i><span>Thu, Dec 24 2020</span></li>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="notes-card">
                        ...
                        <div class="notes-card-content">
                            <h5><a href="Note-Details.html">Computer Science Illuminted - Seventh Edition</a></h5>
                            <ul class="notes-card-content-details">
                                <li><i class="fa fa-university"></i><span>University of California, US</span></li>
                                <li><i class="fa fa-book"></i><span>204 Pages</span></li>
                                <li><i class="fa fa-calendar"></i><span>Thu, Dec 24 2020</span></li>
                ...
                <div class="col-md-4">
                    <div class="notes-card">
                        ...
                        <div class="notes-card-content">
                            <h5><a href="Note-Details.html">The Principles of Computer Hardware - Oxford</a></h5>
                            <ul class="notes-card-content-details">
                                <li><i class="fa fa-university"></i><span>University of California, US</span></li>
                                <li><i class="fa fa-book"></i><span>204 Pages</span></li>
                                <li><i class="fa fa-calendar"></i><span>Thu, Dec 24 2020</span></li>
                ...
                <div class="col-md-4">
                    <div class="notes-card">
                        ...
                        <div class="notes-card-content">
                            <h5><a href="Note-Details.html">The Computer Book</a></h5>
                            <ul class="notes-card-content-details">
                                <li><i class="fa fa-university"></i><span>University of California, US</span></li>
                                <li><i class="fa fa-book"></i><span>204 Pages</span></li>
                                <li><i class="fa fa-calendar"></i><span>Thu, Dec 24 2020</span></li>
