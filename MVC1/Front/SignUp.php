                            ...
                            <form action="" method="post">
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="lastname" class="form-control" id="signup-last-name" placeholder="Enter your last name" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="confirmpassword" class="form-control" id="signup-confirm-password" placeholder="Re-enter your password" required>
