<nav class="navbar fixed-top navbar-expand-lg navbar-light" id="mynav">
        <div class="container">
            <a class="navbar-brand" href="index.php"><img src="images/Homepage/logo.png" alt="logo" class="img-responsive"></a>
                ...
                <ul class="navbar-nav">
                    ...
                    <?php 
                        if(isset($_SESSION['user_id'])) {
                            echo '<li class="nav-item">
                                    <a class="nav-link" href="BuyerRequest-page.php">Buyer Requests</a>
                                </li>';
                        }
                    ...
                    <?php 
                        if(isset($_SESSION['user_id'])) {
                            ...
                            if(empty($user_DP)) {
                                $user_DP = "images/user-img/default-profile.jpg";
                            }
                            ...
                            echo '<li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item" href="User-Profile page.php">My Profile</a>
